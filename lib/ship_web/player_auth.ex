defmodule ShipWeb.PlayerAuth do
  use ShipWeb, :verified_routes
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ShipWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_player:
      ...
      defmodule ShipWeb.PageLive do
        use ShipWeb, :live_view

        on_mount {ShipWeb.PlayerAuth, :mount_current_player}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ShipWeb.PlayerAuth, :ensure_authenticated}] do
